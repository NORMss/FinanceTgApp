...
145 тестов: арифметика денег, проверка `initData`, инварианты журнала (сплиты, балансы,
...
операций при удалении категории, умолчания по счетам и отдельный файл на то, что
приложение не рассказывает о себе лишнего.
