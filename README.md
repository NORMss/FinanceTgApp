...
135 тестов: арифметика денег, проверка `initData`, инварианты журнала (сплиты, балансы,
...
сохранность данных при миграции, наполнение демо, часовые пояса напоминаний и отдельный
файл на то, что приложение не рассказывает о себе лишнего.
